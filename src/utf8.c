...
static bool search_table(uint32_t c, const unicode_data_table_t *table, size_t len)
{
	// Check if within range
	if (c < table[0].first || c > table[len - 1].last) {
		return false;
	}
...
{
	static const unicode_data_table_t zero_width[] = {
	...
	static const unicode_data_table_t wide_width[] = {
		...
		{ 0x02639, 0x02639 }, { 0x0263a, 0x0263a }, { 0x02648, 0x02653 }, { 0x0267f, 0x0267f },
